 ...
 */
class CRM_DataprocessorSearch_Controller_CaseSearch extends CRM_Core_Controller {
  ...
  public function __construct($title = NULL, $modal = TRUE, $action = CRM_Core_Action::NONE) {
    ...
    $this->set('component_mode', CRM_Contact_BAO_Query::MODE_CASE);
    $this->_stateMachine = new CRM_DataprocessorSearch_StateMachine_CaseSearch($this, $action);
